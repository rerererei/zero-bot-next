...
| [zero_bot_rainbowl_private_rooms](./zero_bot_rainbowl_private_rooms.md) | プライベートルーム機能のアクティブルーム状態・所有者ロック・未送信ログキュー | guild_id | sort_key | [data/rainbowl/private_room_store.py](../../../data/rainbowl/private_room_store.py) | 新規（[scripts/setup_private_room_table.py](../../../scripts/setup_private_room_table.py)） |

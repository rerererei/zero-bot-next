...
# =========================
#  永続化バックエンド（rainbowl専用）
# =========================
store = DynamoStore(table_name="zero_bot_rainbowl_xp")
...
def get_rank_bg_key(gid: int, uid: int) -> str:
    ...
    # 1) ギルド設定（zero_bot_guild_config の rankcard.rank_bg_key）
...
# =========================
#  レベル計算ロジック（data/store.pyと同じ式で開始し、以後は独立して調整する）
# =========================
